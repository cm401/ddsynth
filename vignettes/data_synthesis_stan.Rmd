...
```{r traceplots, fig.width=10, fig.height=8, purl=FALSE}
...
```{r posterior-summaries, purl=FALSE}
...
```{r plot-pred, fig.width=10, fig.height=5, purl=FALSE}
...
```{r plot-params, fig.width=6, fig.height=8, purl=FALSE}
...
```{r cdf, fig.width=8, fig.height=10, purl=FALSE}
cdf_summaries <- list()
